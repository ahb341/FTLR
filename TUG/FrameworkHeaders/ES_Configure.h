...
#define SERV_0_HEADER "PumpService.h"
// the name of the Init function
#define SERV_0_INIT InitPumpService
// the name of the run function
#define SERV_0_RUN RunPumpService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "TUG_CommComm.h"
// the name of the Init function
#define SERV_1_INIT InitTUGCommComm
// the name of the run function
#define SERV_1_RUN RunTUGCommComm
// How big should this services Queue be?
...
typedef enum
{
  ...
  ES_PairingRequest,        /* received pairing request from PILOT */
  ES_ControlPacketRecd,     /* received control packet */
  ES_PairButtonPushed,      /* physical pair reset button pressed */

  EV_THRUST_UPDATE,         /* write new values to PWM pins */
  ES_RefuelCmd,             /* we got a refeul command */
}ES_EventType_t;
...
#define TIMER0_RESP_FUNC PostPumpService
...
#define TIMER10_RESP_FUNC PostTUGCommComm
#define TIMER11_RESP_FUNC PostTUGCommComm
