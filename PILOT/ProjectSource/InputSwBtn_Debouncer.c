...
#define bounceRead  PORTAbits.RA3

#define bounceTimer InputSwBtn_Debounce_Timer // locally store it for ease of changing it around
        ...
        case ES_TIMEOUT:
        {
          if (bounceTimer == ThisEvent.EventParam) 
          {
            ...
            // override re-fuelling, disable during production!
              ...
              printf("Input Switcher button Press-and-Hold! \n\r");
      ...
      case ES_TIMEOUT:
      {
        if (bounceTimer == ThisEvent.EventParam)
        {
          ...
          if (1 == currVal) 
          {
            ...
            if (stablized)
            {
              ...
              if (false == hasSentEvent)
              {
                ...
                if (LONG_PRESS_THRESHOLD > pressLength) 
                {
                  ...
                  #ifdef Announce_ShortLong 
                    printf("Input Switcher button Short press! \n\r");
                  #endif /* Announce_ShortLong */
                }
                else
                {
                  ...
                  #ifdef Announce_ShortLong 
                    printf("Input Switcher button Long press! \n\r");
                  #endif /* Announce_ShortLong */
                }
              }
            }
            ...
            #ifdef DEBOUNCE_PRINT
              printf("Input Switcher Button is now HIGH\n\r");
            #endif
          } 
          else 
          {
