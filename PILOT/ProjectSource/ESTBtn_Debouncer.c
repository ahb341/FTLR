...
#define bouncePin   _Pin_4  //RA4 - Joystick 2
#define bouncePort  _Port_A
#define bounceRead  PORTAbits.RA4

#define bounceTimer ESTBtn_Debounce_Timer // locally store it for ease of changing it around
